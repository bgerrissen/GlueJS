define([
    ...
    var test = new UnitTest("testObjectClass", 12 );

    var Class = {

        constructor: function ( node, a, b ){

            var instance = this;

            test.assert( Class.isPrototypeOf( instance ) , "should be an instance" );
            test.equals( "testObjectClass", node.id, "should be bound to correct element ( first argument )" );
